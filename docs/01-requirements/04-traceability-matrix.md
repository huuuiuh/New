...
| --- | --- | --- | --- | --- | --- |
| FR-1.1–1.8 intake, spec, Active Constraint Set | UW-1; `05-generation/01` §2.1; `05-generation/03` §7; `04-memory-canon/04` §2.5 | `story-intake`, `story-spec` (text + language + text_en), `common.localizedText`; `active_constraint_sets` table; `chapter-contract.active_constraints_ref` | 0019, 0033 | B-1-17, B-2-1, B-3-2 | §2 constraint compiler; §4 workflow; §10 injection |
